...
serve(async (req) => {
  ...
  try {
    ...
    const patternDescriptions: Record<string, string> = {
      ...
      "gradient-radial": "radial/circular gradient from center",
      "gradient-radial-top-left": "radial gradient from top-left corner",
      "gradient-radial-top-right": "radial gradient from top-right corner",
      "gradient-radial-bottom-left": "radial gradient from bottom-left corner",
      "gradient-radial-bottom-right": "radial gradient from bottom-right corner",
