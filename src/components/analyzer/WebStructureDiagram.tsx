...
const SECTION_TYPE_CONFIG: Record<string, { label: string; icon: React.ElementType; color: string }> = {
  ...
  'value-proposition': { label: 'Value Props', icon: CheckCircle2, color: '#0066ff' },
  'statistics': { label: 'Statistics', icon: BarChart3, color: '#f59e0b' },
  'testimonial': { label: 'Testimonial', icon: Quote, color: '#4b5563' },
  'feature-list': { label: 'Features', icon: List, color: '#2563eb' },
  'program-description': { label: 'Program', icon: GraduationCap, color: '#1d4ed8' },
