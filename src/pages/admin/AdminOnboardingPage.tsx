...
export default function AdminOnboardingPage() {
  ...
  const fetchTenants = async () => {
    try {
      const { data, error } = await supabase
        ...
        .neq('institution_name', 'CampusVoice.ai System')
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const roleLabel = selectedRole === 'user_approver' ? 'University User + Approver' : selectedRole === 'super_admin' ? 'CampusVoice.ai Super Admin' : 'University User';
      toast({
