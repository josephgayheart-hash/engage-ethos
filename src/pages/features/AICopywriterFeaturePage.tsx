...
import AICopywriterShowcaseDemo from "@/components/feature-showcases/AICopywriterShowcaseDemo";
      ...
      <section className="py-16 bg-[hsl(173_40%_96%)] relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">Watch a real conversation — drafting, refining, and switching channels — all grounded in your brand.</p>
          </div>
          <div className="max-w-4xl mx-auto">
            <AICopywriterShowcaseDemo />
          </div>
        </div>
      </section>
